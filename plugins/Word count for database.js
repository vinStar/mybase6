...
//sValidation=nyfjs
//sCaption=Word count for database ...
//sHint=Count words for the current database
//sCategory=MainMenu.Plugins
//sLocaleID=Menu.Plugin.WordCountDatabase
//sAppVerMin=6.0
//sShortcutKey=
...
var _action=function(){
	plugin.initProgressRange('Word count for database');
	...
	var sSsgPath=plugin.getDefRootContainer();
	xNyf.traverseOutline(sSsgPath, true, _act_on_treeitem);
	_reveal(xRes, '** Word count for the current database **');
};
